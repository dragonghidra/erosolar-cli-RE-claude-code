...
export class AgentSessionService {
  ...
  private readonly passphraseStorageKey = 'erosolar-session-passphrase';
  private readonly passphraseState = signal<string>(this.readStoredPassphrase());
  private readonly firebaseTokenStorageKey = 'erosolar-session-firebase-token';
  ...
  private readInitialSessionId(): string | null {
    ...
    const globalSessionId = (globalThis as unknown as { EROSOLAR_SESSION_ID?: string }).EROSOLAR_SESSION_ID;
