...
@Component({
  ...
  template: `
    <article
      class="chat-message"
      [ngClass]="{
        'message--erosolar': message.agent === 'erosolar',
        'message--erosolar-code': message.agent === 'erosolar-code',
    ...
    >
      <div class="message-meta">
        <span
          class="agent-chip"
          [ngClass]="{
            'agent-chip--erosolar': message.agent === 'erosolar',
            'agent-chip--erosolar-code': message.agent === 'erosolar-code',
